...
public class JwtService {
	...
	public Boolean isAdmin(String token) {
		...
		Boolean res = claim.get("isAdmin", Boolean.class);
	...
	public String generateToken(User userdetails) {
		...
		extra.put("isAdmin",
				userdetails.getRole() == Role.ADMIN.toString() ? true : false);
		return generateToken(extra, userdetails);
	}

	public String generateToken(Map<String, Boolean> extraClaims,
			User userdetails) {
